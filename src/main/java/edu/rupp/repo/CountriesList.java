...
public class CountriesList {
    ...
    /*public static  getCountries(){
    	List<String> countries = (List<String>) getAllCountries();//(List<String>) CountriesList.getAllCountries();
    ...
    public static Set<String> getCountriesByFirstLetter(){
    	List<String> countries = (List<String>) getAllCountries();
    ...
    public static Map<String, Set<String>> getCounties(){//good by lecturer comment
    	List<String> countries = (List<String>) getAllCountries();
    	Map<String, Set<String>>groupCountries = new HashMap<String, Set<String>>();
    ...
    public static void getCountriesByFirstLetter(Map<String, Set<String>> countries, String letter) {
    ...
    public static void main(String[] args) {
    	Map<String, Set<String>> ls = getCounties();
    	System.out.println(ls);
    	
    	Map<String, Set<String>>groupCountries = new HashMap<String, Set<String>>();
    	groupCountries = getCounties();
    	getCountriesByFirstLetter(groupCountries, "z");
